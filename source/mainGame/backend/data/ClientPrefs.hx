...
class SaveVariables {
	...
	public var iconBounceType:String = 'In';
	...
	//vemer engine
	public var ratingHud:Bool = false;
	public var gameLanguage:String = 'English';

	public var showFpsCounter:Bool = true;
	public var showMEM:Bool = true;
	public var showMemPEAK:Bool = true;

	public var showRatingTxt:Bool = false;
	public var ratingType:String = "forever";

	public var showComboSprite:Bool = true;
...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		if(Main.fpsVar != null) {
			openfl.display.FPS.showFpsCounter = data.showFpsCounter;
		}

		if(Main.fpsVar != null) {
			openfl.display.FPS.showMEM = data.showMEM;
		}

		if(Main.fpsVar != null) {
			openfl.display.FPS.showMemPEAK = data.showMemPEAK;
		}
