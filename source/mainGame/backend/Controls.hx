...
class Controls
{
	...
	public var TROPHEY_MENU(get, never):Bool;
	public var MODS_MENU(get, never):Bool;
	private function get_ACCEPT() return justPressed('accept');
	private function get_BACK() return justPressed('back');
	private function get_PAUSE() return justPressed('pause');
	private function get_RESET() return justPressed('reset');
	private function get_TROPHEY_MENU() return justPressed('Achievments_menu');
	private function get_MODS_MENU() return justPressed('mods_menu');
