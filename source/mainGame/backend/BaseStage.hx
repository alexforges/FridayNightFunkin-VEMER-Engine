...
class BaseStage extends FlxBasic
{
	...
	public var cinemaHUD(get, never):FlxCamera;
	...
	{
		onPlayState = (Std.isOfType(value, mainGame.states.PlayState));
		game = value;
		return value;
	}
	...
	inline private function get_momGroup():FlxSpriteGroup
		return game.momGroup;
	...
	inline private function get_cinemaHUD():FlxCamera
		return game.cinemaHUD;
	...
	inline private function get_defaultHUDZoom():Float
		return game.defaultHUDZoom;
	inline private function set_defaultHUDZoom(value:Float):Float
	{
		game.defaultHUDZoom = value;
		return game.defaultHUDZoom;
	}
