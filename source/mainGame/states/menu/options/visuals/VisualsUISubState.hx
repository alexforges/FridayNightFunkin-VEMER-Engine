...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var option:Option = new Option('Rating in hud',
			"If unchecked, disables the Rating in [CamHud].",
			'ratingHud',
			'bool');
		addOption(option);
		...
		var option:Option = new Option('Show Memory Counter',
			"If unchecked, hides FPS Counter.",
			'showMEM',
			'bool');
		addOption(option);

		var option:Option = new Option('Show Memory Peak Counter',
			"If unchecked, hides FPS Counter.",
			'showMemPEAK',
			'bool');
		addOption(option);
		...
		var option:Option = new Option('Icon Bounce:',
			"What should the Icon Bounce Like?",
			'iconBounceType',
			'string',
			['In','Out','Disabled']);
		addOption(option);
		...
		var option:Option = new Option('Rating Type:',
			"What should the Rating Type Like?",
			'ratingType',
			'string',
			TypeRating.typeRatingList);
		addOption(option);
