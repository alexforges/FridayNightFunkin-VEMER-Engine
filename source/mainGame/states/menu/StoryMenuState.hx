...
import mainGame.objects.MenuItem;
import mainGame.objects.MenuCharacter;

import mainGame.substates.GameplayChangersSubstate;
import mainGame.substates.ResetScoreSubState;
...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07, bgSprite.y + 425).loadGraphic(Paths.image(dist + suffix +'/'+'Menu_Tracks'));
