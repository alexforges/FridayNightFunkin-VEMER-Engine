...
import mainGame.shaders.ColorSwap;

import mainGame.states.menu.StoryMenuState;
import mainGame.states.menu.OutdatedState;
import mainGame.states.menu.StoryMenuState;
...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		Aplication.setStateName('Title');
		#end
		
		Mouse.loadMouse(true, 'cursor', 1);
		...
		state building \n
		beta state \n
		and more unfinished stuff\n
		if u see bug plz report in \n
			discord: vemer \n
		thx for supporting :D
		');
	...
	function startIntro()
	{
		...
		titleText.frames = Paths.getSparrowAtlas(standartDirectory+suffix+'titleEnter');
	...
	{
		#if MODS_ALLOWED
		var firstArray:Array<String> = Mods.mergeAllTextsNamed('data/introText/introText'+suffix+'.txt', Paths.getPreloadPath());
		#else
