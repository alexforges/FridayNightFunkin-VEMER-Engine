...
class Flixel extends FlxView3D
{
	...
	public function new(x:Float = 0, y:Float = 0, width:Int = -1, height:Int = -1)
	{
		...
		material = new TextureMaterial(Cast.bitmapTexture("assets/3dAssets/texture/head.png"));
		material.lightPicker = lightPicker;

		var __flixelModel = Assets.getBytes("assets/3dAssets/models/head.obj");
		assetLoaderContext.mapUrlToData("flixel.mtl", Assets.getBytes("assets/3dAssets/texture/head.mtl"));
