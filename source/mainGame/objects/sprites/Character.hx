...
import mainGame.states.stages.objects.TankmenBG;
...
class Character extends FlxSprite
{
	...
	public var iconPosition:Array<Float> = [0, 0];
	public var iconManyType:Float = 2;
	public var iconAnimatied:Bool = false;
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			default:
				...
				iconManyType = json.iconType;
				iconAnimatied = json.iconAnim;
