...
class LuaUtils
{
	...
	public static inline function getLowestCharacterGroup():FlxSpriteGroup
	{
		...
		var newPos:Int = PlayState.instance.members.indexOf(PlayState.instance.momGroup);
		if(newPos < pos)
		{
			group = PlayState.instance.momGroup;
			pos = newPos;
		}
	...
	public static function cameraFromString(cam:String):FlxCamera {
		switch(cam.toLowerCase()) {
			case 'cinemahud': return PlayState.instance.cinemaHUD;
