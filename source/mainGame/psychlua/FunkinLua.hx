...
import mainGame.psychlua.LuaUtils.LuaTweenOptions;
#if (SScript >= "3.0.0")
import mainGame.psychlua.HScript;
#end
import mainGame.psychlua.DebugLuaText;
import mainGame.psychlua.ModchartSprite;
...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('vanillaHUD', PlayState.vanillaHud);
		...
		set('defaultBoyfriendX', game.bfPosition[0]);
		set('defaultBoyfriendY', game.bfPosition[1]);
		set('defaultOpponentX', game.dadPosition[0]);
		set('defaultOpponentY', game.dadPosition[1]);
		set('defaultGirlfriendX', game.gfPosition[0]);
		set('defaultGirlfriendY', game.gfPosition[1]);
		set('defaultMomX', game.momPosition[0]);
		set('defaultMomY', game.momPosition[1]);
	...
	public function initLuaShader(name:String, ?glslVersion:Int = 120)
	{
		...
		var foldersToCheck:Array<String> = [Paths.shaderFragment('shaders/')];
		if(Mods.currentModDirectory == null && Mods.currentModDirectory.length > 0)
			foldersToCheck.insert(0, Paths.shaderFragment('shaders/'));
